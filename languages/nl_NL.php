...
$lang['email_reset_body'] = 'Hallo,<br/><br/>Om je wachtwoord te herstellen, klik deze link:<br/><br/><strong><a href="%1$s/%2$s">%1$s/%2$s</a></strong><br/><br/> Vervolgens moet je deze herstelsleutel gebruiken: <strong>%3$s</strong><br/><br/>Als je recent geen herstelsleutel voor je wachtwoord hebt aangevraagd op %1$s, dan is dit bericht foutief verstuurd - gelieve het te negeren.';
