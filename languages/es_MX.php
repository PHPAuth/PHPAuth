...
$lang['user_verify_failed'] = "El código Captcha es inválido.";

$lang['email_password_invalid'] = "El correo electrónico o la contraseña son inválidos.";
$lang['email_password_incorrect'] = "El correo electrónico o la contraseña son incorrectos.";
$lang['remember_me_invalid'] = "El campo de 'Recuérdame' es inválido.";
...
$lang['newpassword_long'] = "La nueva contraseña es demasiado larga.";
$lang['newpassword_invalid'] = "La nueva contraseña debe contener al menos una letra mayúscula ,una letra minúscula y un dígito.";
...
$lang['email_short'] = "El correo electrónico es demasiado corto.";
$lang['email_long'] = "El correo electrónico es demasiado largo.";
...
$lang['system_error'] = "Ha ocurrido un error en el sistema. Por favor, inténtelo de nuevo.";
...
$lang['email_activation_body'] = 'Hola,<br/><br/>Para iniciar sesión en tu cuenta de usuario ,primero tienes que activar tu cuenta dando click en el siguiente enlace: <strong><a href="%1$s/%2$s">%1$s/%2$s</a></strong><br/><br/> Después, necesitas usar la siguiente clave de activación: <strong>%3$s</strong><br/><br/> Si no te registraste en %1$s recientemente entonces este mensaje fue enviado por error, por favor ignóralo.';
$lang['email_activation_altbody'] = 'Hola, ' . "\n\n" . 'Para iniciar sesión en tu cuenta de usuario primero tienes que activar tu cuenta dando click en el siguiente enlace :' . "\n" . '%1$s/%2$s' . "\n\n" . 'Después, necesitas usar la siguiente clave de activación: %3$s' . "\n\n" . 'Si no te registraste en %1$s recientemente entonces este mensaje fue enviado por error, por favor ignóralo';

$lang['email_reset_subject'] = '%s - Petición para reiniciar la contraseña';
$lang['email_reset_body'] = 'Hola,<br/><br/>Para reiniciar tu contraseña por favor haga click en el siguiente enlace:<br/><br/><strong><a href="%1$s/%2$s">%1$s/%2$s</a></strong><br/><br/>Después, necesitas usar la siguiente clave de reinicio: <strong>%3$s</strong><br/><br/>Si no solicitaste reiniciar tu contraseña en %1$s ,por favor ignora este mensaje.';
$lang['email_reset_altbody'] = 'Hola, ' . "\n\n" . 'Para reiniciar tu contraseña ,por favor haga click en el siguiente enlace:' . "\n" . '%1$s/%2$s' . "\n\n" . 'Después, necesitas usar la siguiente clave de reinicio: %3$s' . "\n\n" . 'Si no solicitaste reiniciar tu contraseña en %1$s ,por favor ignora este mensaje.';

$lang['account_deleted'] = "La cuenta ha sido borrada con éxito.";
